...
import { faBed, faBedPulse, faBuilding, faCalendarCheck, faChartLine, faCreditCard, faFileInvoice, faFileMedical, faMortarPestle, faPills, faUserDoctor, faUserNurse, faVials } from "@fortawesome/free-solid-svg-icons";
import { faCreditCardAlt } from "@fortawesome/free-regular-svg-icons";
// import {FaUserDoctor} form 'react-icons/'
                    ...
                    <ul className="metismenu list-unstyled" id="side-menu">
                            ...
                            <React.Fragment>
                                ...
                                <li>
                                    <Link to="/dashboard" className="waves-effect">
                                        ...
                                        <span className="badge rounded-pill bg-success float-end">3</span>
                                        <span className="ms-2">{this.props.t('Dashboard')}</span>
                                    </Link>
                                </li>
                                <li>
                            <Link to="/#" className="has-arrow waves-effect">
                                ...
                                <span className="ms-2">{this.props.t('Doctors')}</span>
                            </Link>
                            <ul className="sub-menu">
                        ...
                        <li>
                            <Link to="/#" className="has-arrow waves-effect">
                                ...
                                <span className="ms-2">{this.props.t('Patients')}</span>
                            </Link>
                            <ul className="sub-menu">
                        ...
                        <li>
                            <Link to="/#" className="has-arrow waves-effect">
                                ...
                                <span className="ms-2">{this.props.t('Appointments')}</span>
                            </Link>
                            <ul className="sub-menu">
                        ...
                        <li>
                            <Link to="/#" className="has-arrow waves-effect">
                                ...
                                <FontAwesomeIcon icon={faUserNurse} size="xl"  />
                                <span className="ms-2">{this.props.t('Nurses')}</span>
                            </Link>
                            <ul className="sub-menu">
                        ...
                        <li>
                            <Link to="/#" className="has-arrow waves-effect">
                                ...
                                <span className="ms-2">{this.props.t('Departments')}</span>
                            </Link>
                            <ul className="sub-menu">
                        ...
                        <li>
                            <Link to="/#" className="has-arrow waves-effect">
                                ...
                                <span className="ms-2">{this.props.t('Medicines')}</span>
                            </Link>
                            <ul className="sub-menu">
                        ...
                        <li>
                            <Link to="/#" className="has-arrow waves-effect">
                                ...
                                <span className="ms-2">{this.props.t('Beds')}</span>
                            </Link>
                            <ul className="sub-menu">
                        ...
                        <li>
                            <Link to="/#" className="has-arrow waves-effect">
                                {/* <i className=" ri-calendar-event-line"></i> */}
                                <FontAwesomeIcon icon={faMortarPestle}  size="xl" />
                                <span className="ms-2">{this.props.t('Prescriptions')}</span>
                            </Link>
                            <ul className="sub-menu">
                        ...
                        <li>
                            <Link to="/#" className="has-arrow waves-effect">
                                ...
                                <span className="ms-2">{this.props.t('Prescription Details')}</span>
                            </Link>
                            <ul className="sub-menu">
                        ...
                        <li>
                            <Link to="/#" className="has-arrow waves-effect">
                                ...
                                <span className="ms-2">{this.props.t('Invoice')}</span>
                            </Link>
                            <ul className="sub-menu">
                        ...
                        <li>
                            <Link to="/#" className="has-arrow waves-effect">
                                {/* <i className=" ri-calendar-event-line"></i> */}
                                <FontAwesomeIcon icon={faVials} size="xl"  />
                                <span className="ms-2">{this.props.t('Lab Test')}</span>
                            </Link>
                            <ul className="sub-menu">
                        ...
                        <li>
                            <Link to="/#" className="has-arrow waves-effect">
                                {/* <i className=" ri-calendar-event-line"></i> */}
                                <FontAwesomeIcon icon={faCreditCardAlt} size="xl" />
                                <span className="ms-2">{this.props.t('Payment')}</span>
                            </Link>
                            <ul className="sub-menu">
